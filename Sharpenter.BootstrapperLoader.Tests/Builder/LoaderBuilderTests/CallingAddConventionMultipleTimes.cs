...
namespace Sharpenter.BootstrapperLoader.Tests.Builder.LoaderBuilderTests
{
    public class CallingAddConventionMultipleTimes
    {
        ...
        [Fact(DisplayName = "Should store union of methods generated by added conventions")]
        public void should_store_union_of_methods_generated_by_added_conventions()
        {
            Assert.Equal(new string[] { "ConfigureDevelopment", "ConfigureStaging" }, _loader.Config.ConfigureMethods.Keys.ToArray());
            Assert.Equal(new string[] { "ConfigureDevelopmentContainer", "ConfigureStagingContainer" }, _loader.Config.ConfigureContainerMethods.Keys.ToArray());
        }
    }
}